...
const Products = () => {
    ...
    const headphones = [
        {
            ...
            keyFeatures: ["Active Noise Cancellation", "30hr Battery", "Touch Controls"],
            description: [
        ...
        },
        {
            ...
            keyFeatures: ["Adaptive Noise Cancelling", "50hr Battery", "Voice Assistant"],
            description: [
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Discover our handpicked selection of premium products with exceptional quality and customer
                        satisfaction
                    </p>
                </div>
                    ...
                    <div key={categoryIndex} className="mb-16">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                            ...
                            <Link to={category.link}>
                                <button
                                    className="mt-4 sm:mt-0 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {category.data.map((product) => (
                                <ProductCard key={product.id} product={product} category={category.name.toLowerCase()}/>
                            ))}
                        </div>
                    </div>
                ))}
