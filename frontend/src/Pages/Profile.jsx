...
import {User, Mail, MapPin, Phone, Package, Calendar, DollarSign, Eye} from "lucide-react"
...
const Profile = () => {
    ...
    const user = {
        ...
        avatar: "https://cdn.pixabay.com/photo/2015/10/30/10/40/key-1013662_1280.jpg",
        joinDate: new Date(userInfo?.createdAt).toLocaleDateString('en-US', {year: 'numeric', month: 'long'}),
        /*totalOrders: profileData?.orders?.length || 0,
        totalSpent: profileData?.orders?.reduce((sum, order) => sum + order.totalPrice, 0) || 0,*/
    };
                    ...
                    <div className="container mx-auto px-4 py-16">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="text-center mt-12 md:text-left">
                                ...
                                <p className="text-xl opacity-90 mb-4">Customer since {user.joinDate}</p>
                                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                                    <div className="stat bg-primary-content/20 rounded-lg text-primary-content">
                                        ...
                                        <div className="stat-title text-primary-content/80">Total Orders</div>
                                    </div>
                                    <div className="stat bg-primary-content/20 rounded-lg text-primary-content">
                                        <div className="stat-value text-2xl">${user.totalSpent}</div>
                                        <div className="stat-title text-primary-content/80">Total Spent</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-start gap-3 p-3 bg-base-200 rounded-lg">
                                            ...
                                            <div>
                                                <p className="font-semibold text-sm opacity-70">Address</p>
                                    ...
                                    <div className="card-actions justify-end mt-6">
                                        <button className="btn btn-primary btn-block"
                                                onClick={() => setModalOpen(!modalOpen)}>Edit Profile
                                        </button>
                                ...
                                <div className="card-body">
                                    ...
                                    {orders.length > 0 ? (
                                            ...
                                            <table className="table table-zebra w-full">
                                                ...
                                                {orders.map((order) => (
                                                    <tr key={order.id} className="hover">
                                                        ...
                                                        <td>
                                                            <div
                                                                className={`badge ${getStatusBadge(order.status)} badge-lg`}>{order.status}</div>
                                                        </td>
                                                        <td>
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-sm text-base-content/50 mb-6">Start shopping to see your
                                                orders here</p>
                                            <Link to="/shop">
                        ...
                        <div className="card bg-base-100 shadow-xl">
                            <div className="card-body">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <Link to="/wishlist">
                                        <button className="btn btn-outline btn-block">View Wishlist</button>
                                    </Link>
                                    <Link to="/addresses">
                                        <button className="btn btn-outline btn-block">Manage Addresses</button>
                                    </Link>
                                    <Link to="/payment-methods">
                                        <button className="btn btn-outline btn-block">Payment Methods</button>
                                    </Link>
                                    <Link to="/support">
                                        <button className="btn btn-outline btn-block">Contact Support</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
