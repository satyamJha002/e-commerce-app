    ...
    return (
        <div>
            ...
            <div className="pt-20 px-4 md:px-8 lg:px-16 container mx-auto">
                {/* Hero Section */}
                <div className="relative flex flex-col md:flex-row items-center justify-between p-8 md:p-12 bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 text-white rounded-xl shadow-2xl overflow-hidden">
                    <div className="z-10 max-w-lg space-y-6">
                        ...
                        <p className="text-lg md:text-xl opacity-90">
                            Explore premium products at unbeatable prices. Shop now and elevate your style with EliteShop!
                        </p>
                        <Link to="/all-products">
                            <button className="mt-4 bg-white text-indigo-600 font-semibold py-3 px-8 rounded-full hover:bg-indigo-100 hover:scale-105 transition-transform duration-300">
                                Shop Now
                            </button>
                        </Link>
                    </div>
                    <div className="relative w-full md:w-1/2 mt-8 md:mt-0">
                        <img
                            ...
                            alt="EliteShop products"
                            className="w-full h-64 md:h-96 object-cover rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-500"
                            loading="lazy"
                        />
                ...
                <div className="my-16 bg-indigo-100 rounded-lg p-6 text-center">
                    ...
                    <Link to="/new-arrivals">
                        <button className="mt-4 bg-indigo-600 text-white py-2 px-6 rounded-full hover:bg-indigo-700">Explore Now</button>
                    </Link>
                </div>
                ...
                <div className="my-16 bg-indigo-50 p-8 rounded-lg text-center">
                    ...
                    <form className="mt-4 flex justify-center">
                        ...
                        />
                        <button className="bg-indigo-600 text-white py-3 px-6 rounded-r-full hover:bg-indigo-700">Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
