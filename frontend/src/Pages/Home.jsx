...
const Home = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      cardDescription:
        "Enjoy immersive sound quality with noise-cancelling headphones.",
      ...
      <div className="pt-20 px-4 md:px-8 lg:px-16 container mx-auto">
            ...
            {categories.map((category) => (
              <Link key={category.id} to={category.path}>
                <div className="group flex flex-col items-center text-center space-y-3 bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                  <picture>
                    <source
                      srcSet={`${category.src}?format=webp`}
                      type="image/webp"
                    />
                    <img
                      src={category.src}
        ...
        <div className="my-16 bg-indigo-100 rounded-lg p-6 text-center">
          ...
          <p className="text-lg text-gray-600 mt-2">
            Discover the latest trends in fashion and tech.
          </p>
          <Link to="/new-arrivals">
            <button className="mt-4 bg-indigo-600 text-white py-2 px-6 rounded-full hover:bg-indigo-700">
              Explore Now
            </button>
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-gray-600">
                "EliteShop has the best selection and fast shipping!"
              </p>
        ...
        <div className="my-16 bg-indigo-50 p-8 rounded-lg text-center">
          ...
          <form className="mt-4 flex justify-center">
            ...
            />
            <button className="bg-indigo-600 text-white py-3 px-6 rounded-r-full hover:bg-indigo-700">
              Subscribe
            </button>
          </form>
        </div>
